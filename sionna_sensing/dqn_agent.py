...
from brain import Brain                                 # 神经网络
from uniform_experience_replay import Memory as UER     # 统一经验回放
from prioritized_experience_replay import Memory as PER # 优先经验回放
...
class Agent(object):
    ...
    def __init__(self, state_size, action_size, bee_index, brain_name, arguments):
        ...
        self.brain = Brain(self.state_size, self.action_size, brain_name, arguments) # 神经网络
        self.memory_model = arguments['memory']         # 记忆回放库的类型
        ...
        self.target_type = arguments['target_type']                     # 目标网络的类型
        self.update_target_frequency = arguments['target_frequency']    # 更新目标网络的频率
        self.max_exploration_step = arguments['maximum_exploration']    # 最大探索步数
