...
class DQN():
    ...
    def learn(self):
        ...
        print(f"shape of batch_memory: {batch_memory.shape}")
...
class Environment():
    ...
    def get_observation(self):
        ...
        image = self._get_scene_image(filename = "observation.png")
...
def run():
    ...
    for episode in range(3000):
        ...
        while True:
            ...
            if (step >= RL.batch_size) and (step % RL.batch_size == 0):
                RL.learn()
...
if __name__ == "__main__":
    ...
    env = Environment()
    model_save_path = f'./models/street/dqn3/' # 模型保存路径
    RL = DQN(env.n_features,env.action_space,memory_size=1000,best_action=True,best_prob=0.8,reward_decay=0,batch_size=32,replace_target_iter=5)
    run() 
